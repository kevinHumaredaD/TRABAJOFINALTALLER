...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-07-2021 a las 04:26:54
...
(30, 'Crujiente con pomelo y yogur en vasito', 'Si las gachas o el porridge de avena no te convence por su textura blanda, prueba a preparar tu propio muesli. ', 20, 'facil', 'receta/pomelo y yogurt.jpg', 'Paso 1: Comenzaremos pelando a lo vivo el pomelo, seguidamente le separamos los gajos y le quitamos las telillas blancas. \r\n⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀\r\n\r\n\r\nPaso 2: Cortamos en dados la fruta. \r\n⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀\r\n\r\n\r\nPaso 3: La repartimos en dos y echamos la cuarta parte en el fondo de cada vaso. \r\n⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀\r\n\r\n\r\nPaso 4: Echamos una capa de yogur, una capa de muesli y le añadimos una de las cucharadas de miel.\r\n⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀\r\n\r\n\r\nPaso 5: Repetir esta operación hasta acabar con los ingredientes. Servir rápidamente para evitar que los cereales se ablanden.', 6),
(31, 'Smoothie de fresa, aguacate y queso', 'refrescante, cremoso, saciante y delicioso. Se prepara en cero coma, igual que el resto y es perfecto para llevar y beber de camino al trabajo cuando no tenemos tiempo de desayunar tranquilamente en casa', 15, 'facil', 'receta/smoothiefresa.jpg', 'Paso 1: Lavamos las fresas a conciencia bajo un chorro de agua fría, retiramos las hojas verdes y la parte blanca que puedan tener y las colocamos en el vaso de la batidora. Yo he utilizado Thermomix porque le da una textura estupenda a los smoothies, pero podéis usar cualquier otra. Cortamos el aguacate por la mitad, transversalmente, y separamos las dos mitades. Con ayuda de una cuchara retiramos la carne y la añadimos.\r\n⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀\r\n\r\n\r\nPaso 2: A continuación incorporamos el resto de ingredientes excepto la leche, es decir, el yogur de fresa, la miel y el queso crema. Trituramos a velocidad media-alta durante un par de minutos o hasta que obtengamos una mezcla homogénea. Incorporamos la leche, poco a poco y sin dejar de batir, hasta conseguir el espesor deseado. Guardamos en la nevera hasta el momento de servir.', 4);
